...
import com.creatore.rethinkfork.databinding.FragmentDnsConfigureBinding
...
import com.creatore.rethinkfork.ui.activity.DnsListActivity
import com.creatore.rethinkfork.ui.activity.PauseActivity
import com.creatore.rethinkfork.ui.bottomsheet.DnsRecordTypesBottomSheet
...
import com.creatore.rethinkfork.util.UIUtils.setBadgeDotVisible
...
class DnsSettingsFragment : Fragment(R.layout.fragment_dns_configure) {
    ...
    private fun initView() {
        ...
        // enforce dnssec validation / block bogon dns answers
        b.dcEnableDnssecSwitch.isChecked = persistentState.enableDnssecValidation
        // proxy dns
    ...
    private fun initClickListeners() {
        ...
        b.dcEnableDnssecRl.setOnClickListener {
            b.dcEnableDnssecSwitch.isChecked = !b.dcEnableDnssecSwitch.isChecked
        }

        b.dcEnableDnssecSwitch.setOnCheckedChangeListener { _, enabled ->
            persistentState.enableDnssecValidation = enabled
            logEvent(
                "dnssec enforcement? $enabled",
                "User changed dnssec enforcement setting to $enabled"
            )
        }
