...
class BubbleDismissReceiver : BroadcastReceiver(), KoinComponent {
    ...
    companion object {
        const val ACTION_BUBBLE_DISMISSED = "com.creatore.rethinkfork.action.BUBBLE_DISMISSED"
        const val ACTION_BUBBLE_DISABLE = "com.creatore.rethinkfork.action.BUBBLE_DISABLE"
    }
