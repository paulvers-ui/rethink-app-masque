...
import com.arcadesignpro.auroravpn.customdownloader.RetrofitManager
...
import com.arcadesignpro.auroravpn.util.Constants.Companion.JSON_LATEST
import com.arcadesignpro.auroravpn.util.Constants.Companion.JSON_UPDATE
import com.arcadesignpro.auroravpn.util.Constants.Companion.JSON_VERSION
import com.arcadesignpro.auroravpn.util.Constants.Companion.UPDATE_CHECK_RESPONSE_VERSION
import okhttp3.Call
                ...
                object : Callback {
                    ...
                    override fun onResponse(call: Call, response: Response) {
                        try {
                            ...
                            Logger.i(
                                LOG_TAG_APP_UPDATE,
                                "Server response: shouldUpdate=$shouldUpdate, jsonVersion=$version, versionNumber=$latest"
                            )
                            ...
                            Logger.e(LOG_TAG_APP_UPDATE, "JSON parse error during update check: ${e.message ?: "unknown"}", e)
                            listener.onUpdateCheckFailed(AppUpdater.InstallSource.OTHER, isInteractive)
                        } catch (e: java.io.IOException) {
                            Logger.e(LOG_TAG_APP_UPDATE, "IO error during update check: ${e.message ?: "unknown"}", e)
                            listener.onUpdateCheckFailed(AppUpdater.InstallSource.OTHER, isInteractive)
                        }
                    }
                }
