...
import com.arcadesignpro.auroravpn.databinding.ActivityTunnelSettingsBinding
...
import com.arcadesignpro.auroravpn.ui.dialog.NetworkReachabilityDialog
...
class TunnelSettingsActivity : AppCompatActivity(R.layout.activity_tunnel_settings) {
    ...
    private fun openCustomLanIpDialog() {
        try {
            ...
            val dialog = com.arcadesignpro.auroravpn.ui.dialog.CustomLanIpDialog(
                this,
                persistentState,
                themeId
            )
