...
class FirewallRulesetTest {
    ...
    fun testRuleActions() {
        ...
        assertEquals(com.creatore.rethinkfork.R.integer.block, FirewallRuleset.RULE1B.act)
        
        // RULE8 should be an allow rule
        assertEquals(com.creatore.rethinkfork.R.integer.allow, FirewallRuleset.RULE8.act)
