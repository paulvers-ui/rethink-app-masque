...
@org.robolectric.annotation.Config(sdk = [28], application = android.app.Application::class, shadows = [com.creatore.rethinkfork.shadows.ShadowRouterStats::class])
class WgConfigAdapterTest : KoinTest {
    ...
    fun `test WireguardManager getConfigById with correct Int parameter`() {
        ...
        val mockConfig = mockk<com.creatore.rethinkfork.wireguard.Config>(relaxed = true)
    ...
    fun `test Amnezia configuration detection`() {
        ...
        val mockConfig = mockk<com.creatore.rethinkfork.wireguard.Config>()
    ...
    fun `test context initialization`() {
        ...
        // Robolectric uses the app's own package name (e.g. "com.creatore.rethinkfork"),
