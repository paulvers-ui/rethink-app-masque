...
@Config(
    sdk = [28],
    shadows = [com.creatore.rethinkfork.shadows.ShadowRouterStats::class]
)
class HomeScreenFragmentTest : KoinTest {
    ...
    fun setUp() {
        ...
        try {
            ...
            mockkStatic("com.creatore.rethinkfork.util.UIUtils")
            mockkStatic("com.creatore.rethinkfork.util.Utilities")
            mockkStatic("com.creatore.rethinkfork.scheduler.WorkScheduler")
        ...
        org.koin.core.context.startKoin {
            modules(
                module {
                    ...
                    single { mockk<com.creatore.rethinkfork.database.AppInfoRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.CustomDomainRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.CustomIpRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.WgConfigFilesRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.ProxyEndpointRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.DnsLogRepository>(relaxed = true) }
                    single { mockk<com.creatore.rethinkfork.database.ConnectionTrackerRepository>(relaxed = true) }
