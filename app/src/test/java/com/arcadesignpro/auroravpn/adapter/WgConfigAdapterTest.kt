...
@org.robolectric.annotation.Config(sdk = [28], application = android.app.Application::class, shadows = [com.arcadesignpro.auroravpn.shadows.ShadowRouterStats::class])
class WgConfigAdapterTest : KoinTest {
    ...
    fun `test WireguardManager getConfigById with correct Int parameter`() {
        ...
        val mockConfig = mockk<com.arcadesignpro.auroravpn.wireguard.Config>(relaxed = true)
    ...
    fun `test Amnezia configuration detection`() {
        ...
        val mockConfig = mockk<com.arcadesignpro.auroravpn.wireguard.Config>()
    ...
    fun `test context initialization`() {
        ...
        // Robolectric uses the app's own package name (e.g. "com.arcadesignpro.auroravpn"),
