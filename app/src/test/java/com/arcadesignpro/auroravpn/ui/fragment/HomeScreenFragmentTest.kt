...
@Config(
    sdk = [28],
    shadows = [com.arcadesignpro.auroravpn.shadows.ShadowRouterStats::class]
)
class HomeScreenFragmentTest : KoinTest {
    ...
    fun setUp() {
        ...
        try {
            ...
            mockkStatic("com.arcadesignpro.auroravpn.util.UIUtils")
            mockkStatic("com.arcadesignpro.auroravpn.util.Utilities")
            mockkStatic("com.arcadesignpro.auroravpn.scheduler.WorkScheduler")
        ...
        org.koin.core.context.startKoin {
            modules(
                module {
                    ...
                    single { mockk<com.arcadesignpro.auroravpn.database.AppInfoRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.CustomDomainRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.CustomIpRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.WgConfigFilesRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.ProxyEndpointRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.DnsLogRepository>(relaxed = true) }
                    single { mockk<com.arcadesignpro.auroravpn.database.ConnectionTrackerRepository>(relaxed = true) }
