...
class FirewallRulesetTest {
    ...
    fun testRuleActions() {
        ...
        assertEquals(com.arcadesignpro.auroravpn.R.integer.block, FirewallRuleset.RULE1B.act)
        
        // RULE8 should be an allow rule
        assertEquals(com.arcadesignpro.auroravpn.R.integer.allow, FirewallRuleset.RULE8.act)
