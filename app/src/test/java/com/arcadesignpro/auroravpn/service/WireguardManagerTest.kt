...
import com.arcadesignpro.auroravpn.database.WgConfigFilesRepository
import com.arcadesignpro.auroravpn.service.ProxyManager.ID_WG_BASE
import com.arcadesignpro.auroravpn.wireguard.Config as WgConfig
...
@RobolectricConfig(sdk = [28], application = android.app.Application::class)
class WireguardManagerTest : KoinTest {
    ...
    fun setUp() {
        ...
        // Clear any existing Koin state first to avoid KoinApplicationAlreadyStartedException
        ...
        // Set main dispatcher LAST: after Koin and Application are fully initialised,
        // to prevent app coroutines from landing on the test dispatcher before setup
        // completes and registering UncaughtExceptionsBeforeTest in the next class.
    ...
    fun `test matchesSsidList - complex wildcard patterns`() {
        ...
        // Execute - JSON format required by SsidItem.parseStorageList (## legacy format not supported)
