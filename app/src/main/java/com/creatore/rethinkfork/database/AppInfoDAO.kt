...
import com.creatore.rethinkfork.data.DataUsage
...
interface AppInfoDAO {
    ...
    @Query("update AppInfo set isProxyExcluded = :bypass where packageName = 'com.creatore.rethinkfork'")
    fun setRethinkToBypassProxy(bypass: Boolean)

    @Query("update AppInfo set firewallStatus = 7, connectionStatus = 3 where packageName = 'com.creatore.rethinkfork'")
