...
//import com.creatore.rethinkfork.rpnproxy.RpnProxyManager.RpnMode
//import com.creatore.rethinkfork.rpnproxy.RpnProxyManager.rpnMode
import Logger
...
import com.creatore.rethinkfork.service.UsqueManager
...
import com.creatore.rethinkfork.customdownloader.IpInfoDownloader
import com.creatore.rethinkfork.data.AppConfig
import com.creatore.rethinkfork.data.ConnTrackerMetaData
import com.creatore.rethinkfork.data.ConnectionSummary
import com.creatore.rethinkfork.database.AppInfo
import com.creatore.rethinkfork.database.ConnectionTracker
import com.creatore.rethinkfork.database.ConnectionTrackerRepository
import com.creatore.rethinkfork.database.ConsoleLog
import com.creatore.rethinkfork.database.EventSource
import com.creatore.rethinkfork.database.EventType
import com.creatore.rethinkfork.database.RefreshDatabase
import com.creatore.rethinkfork.net.go.GoVpnAdapter
import com.creatore.rethinkfork.net.manager.ConnectionTracer
import com.creatore.rethinkfork.receiver.NotificationActionReceiver
import com.creatore.rethinkfork.receiver.UserPresentReceiver
import com.creatore.rethinkfork.scheduler.EnhancedBugReport
import com.creatore.rethinkfork.service.FirewallManager.NOTIF_CHANNEL_ID_FIREWALL_ALERTS
import com.creatore.rethinkfork.service.ProxyManager.ID_WG_BASE
import com.creatore.rethinkfork.service.ProxyManager.isNotLocalAndRpnProxy
import com.creatore.rethinkfork.ui.NotificationHandlerActivity
...
import com.creatore.rethinkfork.util.Constants.Companion.INIT_TIME_MS
import com.creatore.rethinkfork.util.Constants.Companion.INVALID_UID
import com.creatore.rethinkfork.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_NAME
import com.creatore.rethinkfork.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_VALUE
import com.creatore.rethinkfork.util.Constants.Companion.PRIMARY_USER
import com.creatore.rethinkfork.util.Constants.Companion.UID_EVERYBODY
import com.creatore.rethinkfork.util.CrashReporter
import com.creatore.rethinkfork.util.Daemons
import com.creatore.rethinkfork.util.IPUtil
import com.creatore.rethinkfork.util.InternetProtocol
import com.creatore.rethinkfork.util.KnownPorts
import com.creatore.rethinkfork.util.MemoryUtils
import com.creatore.rethinkfork.util.NotificationActionType
import com.creatore.rethinkfork.util.Protocol
import com.creatore.rethinkfork.util.ResourceRecordTypes
...
import com.creatore.rethinkfork.util.Utilities.isAtleastR
import com.creatore.rethinkfork.util.Utilities.isAtleastS
import com.creatore.rethinkfork.util.Utilities.isAtleastU
import com.creatore.rethinkfork.util.Utilities.isFdroidFlavour
import com.creatore.rethinkfork.util.Utilities.isMissingOrInvalidUid
import com.creatore.rethinkfork.util.Utilities.isNetworkSame
import com.creatore.rethinkfork.util.Utilities.isPlayStoreFlavour
import com.creatore.rethinkfork.util.Utilities.isUnspecifiedIp
...
import com.creatore.rethinkfork.util.NetworkAlertManager
...
class BraveVPNService : VpnService(), ConnectionMonitor.NetworkListener, Bridge, OnSharedPreferenceChangeListener {
    ...
    companion object {
        ...
        const val ACTION_USQUE_DOZE_WATCHDOG = "com.creatore.rethinkfork.USQUE_DOZE_WATCHDOG"
