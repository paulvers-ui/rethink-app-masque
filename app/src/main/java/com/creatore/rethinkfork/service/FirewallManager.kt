...
import com.creatore.rethinkfork.service.FirewallManager.GlobalVariable.appInfos
import com.creatore.rethinkfork.service.FirewallManager.GlobalVariable.appInfosLiveData
import com.creatore.rethinkfork.service.FirewallManager.GlobalVariable.foregroundUids
...
object FirewallManager : KoinComponent {
    ...
    private val persistentState get() = get<PersistentState>()
